...
import { AudioFile, TranscriptSegment } from '../types/core';
...
export class WhisperTranscription implements EnhancedTranscription {
  ...
  private async prepareAudioData(audioFile: AudioFile): Promise<string | ArrayBuffer> {
  ...
  private formatTranscriptionResult(result: any, processingTime: number): TranscriptionResult {
...
export class DeviceCapabilityDetector {
  ...
  static async checkModelCompatibility(modelSize: WhisperSettings['modelSize']): Promise<boolean> {
